...
public class penerima extends javax.swing.JFrame {
    ...
    protected void kosong(){
     ...
     protected void datatable(){
         Object[] Baris ={"ID","Penerima","ID Barang","Nama Barang","ID Penjual","Nama Penjual","Tanggal","Alamat","No Telp"};
         ...
         try{
            ...
            while(hasil.next()){
             ...
             String e = hasil.getString("id_penjual");
             String f = hasil.getString("nama_penjual");
             String g = hasil.getString("tanggal");
             String h = hasil.getString("alamat");
             String i = hasil.getString("no_telp");
     ...
     */
     ...
     private void kode() {
        try {
            ...
            String sql = "SELECT * FROM penerima ORDER by id desc";
            ResultSet r = s.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        t_temp = new javax.swing.JTextField();
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cb_barang, 0, 201, Short.MAX_VALUE)
                                    .addComponent(t_namapenerima, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                                    .addComponent(t_namabarang, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                                    .addComponent(t_namapenjual)
                                    .addComponent(cb_penjual, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(t_temp, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(t_temp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    private void b_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_simpanActionPerformed
        ...
        try{
            ...
            String nama = t_namapenerima.getText();
            ...
            String telp = t_telp.getText();
                ...
                String sql2="select nama from user order by rand() limit 1";
                ResultSet r = s.executeQuery(sql2);
                while (r.next()) {
                    t_temp.setText(r.getString("nama"));
                }
                String petugas = t_temp.getText();

            String sql="insert into penerima (id,nama,id_barang,nama_barang,id_penjual,nama_penjual,tanggal,alamat,no_telp,petugas)"
            +"values"+"('"+id+"','"+nama+"','"+id_barang+"',"
            + "'"+nama_barang+"','"+id_penjual+"','"+nama_penjual+"','"+tanggal+"','"+alamat+"','"+telp+"','"+petugas+"'  )";

            PreparedStatement stat=conn.prepareStatement(sql);
            stat.executeUpdate();
            
          
            JOptionPane.showMessageDialog(null, "Data TERSIMPAN menugaskan '"+petugas+"', silahkan update data PENUGASAN pada Menu Utama ");
    ...
    private void b_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_ubahActionPerformed
        ...
        try{
            ...
            String sql="UPDATE penerima set nama='"+nama+"',id_barang='"+id_barang+"',"
            + "nama_barang='"+nama_barang+"',id_penjual='"+id_penjual+"',nama_penjual='"+nama_penjual+"',tanggal='"+tanggal+"',alamat='"+alamat+"',"
    ...
    private void b_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_hapusActionPerformed
        try{
            String sql="delete from penerima where id ='"+t_id.getText()+"' ";
    ...
    private void tbl_userMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_userMouseClicked
        ...
        String id_penjual = (String) tableModel.getValueAt(i, 4);
        cb_penjual.setSelectedItem(id_penjual);

        String nama_penjual = (String) tableModel.getValueAt(i, 5);
        t_namapenjual.setText(nama_penjual);

        //String tanggal = (String) model.getValueAt(i, 6);
        //ttanggal.setDate(tanggal);

        String alamat = (String) tableModel.getValueAt(i, 7);
        t_alamat.setText(alamat);

        String telp = (String) tableModel.getValueAt(i, 8);
        t_telp.setText(telp);
    ...
    private javax.swing.JTextField t_temp;
