...
public class penerima extends javax.swing.JFrame {
    ...
    private void b_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_simpanActionPerformed
        ...
        try{
            ...
            String sql="insert into penerima (id,nama,id_barang,nama_barang,id_penjual,nama_penjual,tanggal,alamat,no_telp)"
            +"values"+"('"+id+"','"+nama+"','"+id_barang+"',"
            + "'"+nama_barang+"','"+id_penjual+"','"+nama_penjual+"','"+tanggal+"','"+alamat+"','"+telp+"'  )";
